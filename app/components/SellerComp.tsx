'use client'
import { getProducts, getSellers, supabaseAdmin } from '@/utils/supabase-admin';
...
const SellerComp = () => {
    ...
    const runFun = async () => {
        const order = async () => await getSellers().then((data) => {
            setSeller(data);
        });
        order();
    }
                ...
                <div className="">
                    <div className="w-full ">
                        <div className=" w-full mb-6 lg:mb-0">
                            <h1 className="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900">Sellers</h1>
                            <div className="h-1 w-20 bg-indigo-500 rounded"></div>
                        </div>
                        <p className="py-2 w-full leading-relaxed text-gray-500">Here are the sellers which are present in your organisation.</p>
                    </div>
