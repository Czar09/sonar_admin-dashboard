                        ...
                        <div className="">
                            <div className="w-full ">
                                <div className=" w-full mb-6 lg:mb-0">
                                    <h1 className="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900">Seller Prices</h1>
                                    <div className="h-1 w-20 bg-indigo-500 rounded"></div>
                                </div>
                                <div className='w-1/2 flex md:flex-row flex-col'>
                                    <p className="py-2 w-full leading-relaxed text-gray-500 md:text-2xl text-md">Here are the Seller Prices which are present in your inventory.</p>
                                    ...
                                    proddata?.map(prod => (
                                        <div key={prod?.id} className=" p-2">
                                            <div className={`${prod.quantity < 10 ? `bg-red-300` : `bg-gray-300`} p-3 rounded-lg space-y-2`}>
                                                <h2 className="text-lg text-gray-900 font-medium title-font mb-4">Seller Name: {prod.users.full_name}</h2>
